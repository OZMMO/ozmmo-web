...
import { RentalOverview } from "@/components/dashboard/rental-overview"

export const metadata: Metadata = {
  title: "Dashboard",
  description: "Sistema de Inventario y Renta de Equipos de Purificación de Agua",
}
        ...
        <div className="flex-1 space-y-4 p-4 pt-4">
          <div className="flex items-center justify-between space-y-2">
            ...
            <div className="flex items-center space-x-2">
              <Button>Seleccionar Fechas</Button>
          ...
          <Tabs defaultValue="overview" className="space-y-4">
            <TabsList>
              ...
              <TabsTrigger value="rentals">Rentas</TabsTrigger>
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">Equipos Rentados</CardTitle>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="none"
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                ...
                <Card className="col-span-3">
                  <CardHeader>
                    ...
                    <CardDescription>Has tenido 12 rentas este mes.</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <RecentSales />
                  </CardContent>
